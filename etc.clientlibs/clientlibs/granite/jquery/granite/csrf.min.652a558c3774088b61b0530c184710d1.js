(function (c) {
  ...
  c.Granite.HTTP.externalize =
    ...
    function (g) {
        ...
        a: {
          ...
          try {
            if (c.CQURLInfo) f = CQURLInfo.contextPath || "";
              ...
              for (
                var h = document.getElementsByTagName("script"), k = 0;
                k < h.length;
                k++
              ) {
      ...
      try {
        0 === g.indexOf("/") && f && 0 !== g.indexOf(f + "/") && (g = f + g);
      } catch (p) {}
      return g;
    };
})(this);
(function (c) {
  ...
  XMLHttpRequest.prototype.send = function () {
    if (this._csrf)
      if (e) this.setRequestHeader("CSRF-Token", e), m.apply(this, arguments);
    ...
    Node.prototype.appendChild = function () {
      ...
      if ("IFRAME" === a.nodeName)
        try {
          a.contentWindow &&
            !a._csrf &&
            ((a._csrf = !0), p(a.contentWindow.document));
        } catch (b) {
          a.src &&
            a.src.length &&
            g(a.src) &&
