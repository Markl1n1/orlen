...
(function (p, ba) {
  ...
  function ib() {
    n.addEventListener
      ? (n.removeEventListener("DOMContentLoaded", C),
        p.removeEventListener("load", C))
      : (n.detachEvent("onreadystatechange", C), p.detachEvent("onload", C));
  }
  function C() {
    if (
      n.addEventListener ||
  ...
  function ob(a, b, d, e, f) {
    for (
      var g, h, l, k, m, r, t = a.length, I = nb(b), p = [], n = 0;
      n < t;
      n++
    )
      if ((h = a[n]) || 0 === h)
        if ("object" === c.type(h)) c.merge(p, h.nodeType ? [h] : h);
          ...
          if (!q.tbody)
            for (
              ...
              c.nodeName((m = h.childNodes[g]), "tbody") &&
                !m.childNodes.length &&
                h.removeChild(m);
    ...
    if (h) {
      ...
      if (t || e) {
        ...
        for (f = p.length; g < h; g++)
          (t = r),
            g !== l &&
              ((t = c.clone(t, !0, !0)), f && c.merge(p, y(t, "script"))),
            d.call(a[g], t, g);
        if (f)
          for (
            r = p[p.length - 1].ownerDocument, c.map(p, vb), g = 0;
            g < f;
            g++
          )
            (t = p[g]),
  ...
  function yb(a, b, d) {
    for (var e = b ? c.filter(b, a) : a, f = 0; null != (b = e[f]); f++)
      d || 1 !== b.nodeType || c.cleanData(y(b)),
        b.parentNode &&
          (d && c.contains(b.ownerDocument, b) && Na(y(b, "script")),
        ...
        e.style &&
          ...
          b
            ? (g[h] || "none" !== d || (e.style.display = ""),
              "" === e.style.display &&
                fa(e) &&
                (g[h] = c._data(e, "olddisplay", za(e.nodeName))))
            : ((f = fa(e)),
              ((d && "none" !== d) || !f) &&
  ...
  function Gb(a, b, d, e, f) {
    ...
    for (var g = 0; 4 > b; b += 2)
      "margin" === d && (g += c.css(a, d + T[b], !0, f)),
        e
          ? ("content" === d && (g -= c.css(a, "padding" + T[b], !0, f)),
            "margin" !== d && (g -= c.css(a, "border" + T[b] + "Width", !0, f)))
          : ((g += c.css(a, "padding" + T[b], !0, f)),
            "padding" !== d &&
              (g += c.css(a, "border" + T[b] + "Width", !0, f)));
    return g;
  }
  function Hb(a, b, d) {
    var e = !0,
  ...
  function Jb(a, b, c) {
    for (
      var d,
        f = (S.tweeners[b] || []).concat(S.tweeners["*"]),
        g = 0,
        h = f.length;
      g < h;
      g++
  ...
  c.extend({
    ...
    isPlainObject: function (a) {
      ...
      if (!q.ownFirst) for (b in a) return ra.call(a, b);
      for (b in a);
    ...
    each: function (a, b) {
      var c,
        e = 0;
      if (da(a)) for (c = a.length; e < c && !1 !== b.call(a[e], e, a[e]); e++);
  ...
  var sa = (function (a) {
    function b(a, b, c, d) {
      ...
      if (
        !d &&
        ((b ? b.ownerDocument || b : A) !== w && xa(b), (b = b || w), Y)
      ) {
        if (11 !== v && (u = ta.exec(a)))
          if ((e = u[1]))
            if (9 === v)
            ...
            if (
              ...
              return C.apply(c, b.getElementsByClassName(e)), c;
          }
    ...
    function y(a, b, c, d, e) {
      for (var f, g = [], h = 0, u = a.length, v = null != b; h < u; h++)
        if ((f = a[h])) if (!c || c(f, d, e)) g.push(f), v && b.push(h);
      return g;
    }
    function D(a, c, d, f, g, h) {
      ...
      return e(function (e, h, u, v) {
        ...
        if (!(L = e)) {
          L = c || "*";
          for (
            var r = u.nodeType ? [u] : u, t = [], p = 0, q = r.length;
            p < q;
            p++
          )
            b(L, r[p], t);
        ...
        if (f) {
          var n = y(r, m);
          f(n, [], u, v);
          for (u = n.length; u--; ) if ((l = n[u])) r[m[u]] = !(L[m[u]] = l);
        }
        if (e) {
          if (g || a) {
            if (g) {
              n = [];
              for (u = r.length; u--; ) (l = r[u]) && n.push((L[u] = l));
              g(null, (r = []), n, v);
            }
            for (u = r.length; u--; )
              (l = r[u]) &&
      ...
      var d = 0 < c.length,
        ...
        g = function (e, g, h, u, l) {
          ...
          if (d && U !== m) {
            ...
            if (e) {
              if (0 < m) for (; U--; ) L[U] || r[U] || (r[U] = ba.call(u));
              r = y(r);
            }
            C.apply(u, r);
    ...
    var xa = (b.setDocument = function (a) {
      ...
      (b = w.defaultView) &&
        b.top !== b &&
        (b.addEventListener
          ? b.addEventListener("unload", pa, !1)
          : b.attachEvent && b.attachEvent("onunload", pa));
      ...
      Aa =
        (b = V.test(Z.compareDocumentPosition)) || V.test(Z.contains)
          ? function (a, b) {
        ...
        ? function (a, b) {
            ...
            c =
              (a.ownerDocument || a) === (b.ownerDocument || b)
                ...
                : 1;
            return c & 1 ||
              (!F.sortDetached && b.compareDocumentPosition(a) === c)
              ? a === w || (a.ownerDocument === A && Aa(A, a))
                ? -1
                : b === w || (b.ownerDocument === A && Aa(A, b))
                  ? 1
                  : K
                    ? E(K, a) - E(K, b)
                    : 0
    ...
    var ca = (b.tokenize = function (a, c) {
      ...
      for (h = B.preFilter; g; ) {
        ...
        if ((d = ja.exec(g)))
          (k = d.shift()),
            e.push({ value: k, type: d[0].replace(T, " ") }),
            (g = g.slice(k.length));
        for (f in B.filter)
          !(d = W[f].exec(g)) ||
            (h[f] && !(d = h[f](d))) ||
      ...
      if (1 === l.length) {
        ...
        for (e = W.needsContext.test(a) ? 0 : k.length; e--; ) {
          ...
          if ((g = B.find[g]))
            if (
              (d = g(
                f.matches[0].replace(ma, na),
                (da.test(k[0].type) && r(b.parentNode)) || b,
              ))
            ) {
              k.splice(e, 1);
              a = d.length && p(k);
    ...
    if ("string" === typeof a) {
      ...
      if (e[1]) {
        if (
          ...
          c.merge(
            this,
            c.parseHTML(e[1], b && b.nodeType ? b.ownerDocument || b : n, !0),
          ),
  ...
  c.each(
    ...
    function (a, b) {
      c.fn[a] = function (d, e) {
        ...
        1 < this.length &&
          (yc[a] || (f = c.uniqueSort(f)), xc.test(a) && (f = f.reverse()));
          ...
          g &&
            ...
            (function I(b) {
              c.each(b, function (b, d) {
                c.isFunction(d)
                  ? (a.unique && m.has(d)) || g.push(d)
                  : d && d.length && "string" !== c.type(d) && I(d);
              });
            })(arguments),
            d && !b && k());
          return this;
  ...
  c.event = {
        ...
        for (h = b.length; h--; ) {
          ...
          n &&
            ...
            (m = g[n]) ||
              ((m = g[n] = []),
              (m.delegateCount = 0),
              (p.setup && !1 !== p.setup.call(a, e, q, l)) ||
                (a.addEventListener
                  ? a.addEventListener(n, l, !1)
                  : a.attachEvent && a.attachEvent("on" + n, l))),
            p.add &&
              (p.add.call(a, k), k.handler.guid || (k.handler.guid = d.guid)),
        ...
        for (l = b.length; l--; ) {
          ...
          if (n) {
            ...
            for (h = g = D.length; g--; ) {
              ...
              (!f && m !== C.origType) ||
                (d && d.guid !== C.guid) ||
                (p && !p.test(C.namespace)) ||
                (e && e !== C.selector && ("**" !== e || !C.selector)) ||
                (D.splice(g, 1),
            ...
            h &&
              !D.length &&
              ((y.teardown && !1 !== y.teardown.call(a, q, r.handle)) ||
                c.removeEvent(a, n, r.handle),
              delete k[n]);
          } else for (n in k) c.event.remove(a, n + b[l], d, e, !0);
        }
        c.isEmptyObject(k) && (delete r.handle, c._removeData(a, "events"));
      }
    },
      ...
      if (
        ...
        if (e || !k.trigger || !1 !== k.trigger.apply(d, b)) {
          if (!e && !k.noBubble && !c.isWindow(d)) {
            ...
            f === (d.ownerDocument || n) &&
              h.push(f.defaultView || f.parentWindow || p);
          }
    ...
    fix: function (a) {
      ...
      e ||
        (this.fixHooks[b] = e =
          Bc.test(b) ? this.mouseHooks : Ac.test(b) ? this.keyHooks : {});
  ...
  c.extend({
    ...
    clone: function (a, b, d) {
      ...
      if (b)
        if (d)
          for (k = k || y(a), l = l || y(h), f = 0; null != (e = k[f]); f++)
            wb(e, l[f]);
        else wb(a, h);
      l = y(h, "script");
      ...
      for (
        ...
        if (b || pa(d))
          if ((g = (f = d[l]) && k[f])) {
            ...
            k[f] &&
              (delete k[f],
              m || "undefined" === typeof d.removeAttribute
                ? (d[l] = void 0)
                : d.removeAttribute(l),
              R.push(f));
          }
          ...
          if (
            ...
            try {
              for (; e < f; e++)
                (b = this[e] || {}),
                  1 === b.nodeType &&
                    (c.cleanData(y(b, !1)), (b.innerHTML = a));
              b = 0;
            } catch (g) {}
          }
    ...
    replaceWith: function () {
      ...
      return ea(
        ...
        function (b) {
          ...
          0 > c.inArray(this, a) &&
            (c.cleanData(y(this)), d && d.replaceChild(b, this));
        },
        a,
      );
    },
  ...
  var bb = /alpha\([^)]*\)/i,
    ...
    Gc = /^(none|table(?!-c[ea]).+)/,
    nc = new RegExp("^(" + Ya + ")(.*)$", "i"),
    Hc = { position: "absolute", visibility: "hidden", display: "block" },
  ...
  c.each(["height", "width"], function (a, b) {
    c.cssHooks[b] = {
      get: function (a, e, f) {
        if (e)
          return Gc.test(c.css(a, "display")) && 0 === a.offsetWidth
            ? ab(a, Hc, function () {
                return Hb(a, b, f);
              })
            : Hb(a, b, f);
  ...
  c.cssHooks.marginRight = Ra(q.reliableMarginRight, function (a, b) {
    if (b) return ab(a, { display: "inline-block" }, ia, [a, "marginRight"]);
  });
    ...
    prefilters: [
      function (a, b, d) {
        ...
        if (1 === a.nodeType && ("height" in b || "width" in b)) {
          ...
          "inline" === y &&
            "none" === c.css(a, "float") &&
            (q.inlineBlockNeedsLayout && "inline" !== za(a.nodeName)
              ? (h.zoom = 1)
  ...
  c.fn.extend({
    ...
    stop: function (a, b, d) {
      ...
      return this.each(function () {
        ...
        else for (g in l) l[g] && l[g].stop && Jc.test(g) && e(l[g]);
        for (g = h.length; g--; )
          h[g].elem !== this ||
            (null != a && h[g].queue !== a) ||
  ...
  var Mc = {
    set: function (a, b, d) {
      !1 === b
        ? c.removeAttr(a, d)
        : (Ha && oa) || !cb.test(d)
          ? a.setAttribute((!oa && c.propFix[d]) || d, d)
    ...
    propHooks: {
      tabIndex: {
        get: function (a) {
          ...
          return b
            ? parseInt(b, 10)
            : Nc.test(a.nodeName) || (Oc.test(a.nodeName) && a.href)
              ? 0
              : -1;
        },
      },
              ...
              if ("string" === d) {
                ...
                (b = ja(this)) && c._data(this, "__className__", b),
                  c.attr(
                    this,
                    "class",
                    b || !1 === a ? "" : c._data(this, "__className__") || "",
                  );
            });
    },
    hasClass: function (a) {
  ...
  c.extend({
    ...
    ajax: function (a, b) {
      function d(a, b, d, e) {
        ...
        if (2 !== P) {
          ...
          if (d) {
            var r = m;
            for (
              var t = x, w, K, z, A, Q = r.contents, E = r.dataTypes;
              "*" === E[0];

            )
              E.shift(),
                void 0 === K &&
                  (K = r.mimeType || t.getResponseHeader("Content-Type"));
            if (K)
              for (A in Q)
                if (Q[A] && Q[A].test(K)) {
                  E.unshift(A);
                    ...
                    if (M && d["throws"]) w = M(w);
                      ...
                      try {
                        ...
                        r = {
                          ...
                          error: M
                            ? la
                            : "No conversion from " + G + " to " + A,
                        };
                        break a;
                      }
                }
            }
            r = { state: "success", data: w };
          }
          if (e)
            if (
              (m.ifModified &&
      ...
      m.dataTypes = c
        ...
        .match(J) || [""];
      null == m.crossDomain &&
        ((a = $b.exec(m.url.toLowerCase())),
        (m.crossDomain = !(
          !a ||
          (a[1] === ta[1] &&
            a[2] === ta[2] &&
            (a[3] || ("http:" === a[1] ? "80" : "443")) ===
              (ta[3] || ("http:" === ta[1] ? "80" : "443")))
        )));
      m.data &&
        m.processData &&
      ...
      m.hasContent ||
        (m.data &&
          ((N = m.url += (fb.test(N) ? "\x26" : "?") + m.data), delete m.data),
        !1 === m.cache &&
          (m.url = Zb.test(N)
      ...
      if (m.beforeSend && (!1 === m.beforeSend.call(n, x, m) || 2 === P))
        return x.abort();
      G = "abort";
      for (e in { success: 1, error: 1, complete: 1 }) x[e](m[e]);
      if ((l = Lb(Sa, m, b, x))) {
        x.readyState = 1;
...
jQuery.uaMatch = function (p) {
  ...
  p =
    ...
    /(msie) ([\w.]+)/.exec(p) ||
    (0 > p.indexOf("compatible") && /(mozilla)(?:.*? rv:([\w.]+)|)/.exec(p)) ||
    [];
...
(function (p) {
  ...
  p.htmlPrefilter = function (p) {
    ...
    G !== p &&
      ba(p) !== ba(G) &&
      console.error("HTML tags must be properly nested and closed: " + p);
    return ua(p);
  };
})(window.jQuery);
